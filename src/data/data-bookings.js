...
export const bookings = [
  // CABIN 001
  {
    ...
    hasBreakfast: true,
    observations:
      'من حساسیت به نمک دارم و می خواهم یک صبحانه بدون نمک درخواست کنم.',
    isPaid: false,
    numGuests: 1,
  },
  {
  ...
  },
  {
    ...
    guestId: 9,
    hasBreakfast: false,
    observations: 'ما سگ کوچک خود را با خود خواهیم آورد',
    isPaid: true,
    numGuests: 3,
  },
  {
  ...
  // CABIN 006
  {
    ...
    hasBreakfast: false,
    observations:
      "ما اواخر، حدود نیمه شب میرسیم. امیدوارم خوب باشه :)",
    isPaid: true,
    numGuests: 6,
  },
  {
    ...
    guestId: 18,
    hasBreakfast: true,
    observations: 'برای یکی از مهمانان به تخت تاشو نیاز دارم',
    isPaid: true,
    numGuests: 4,
  },
  {
  ...
  // CABIN 008
  {
    ...
    hasBreakfast: true,
    observations:
      'همسرم به شکر آلرژی دارد، بنابراین در صورت امکان می خواهم یک صبحانه بدون شکر درخواست کنم',
    isPaid: true,
    numGuests: 9,
  },
  {
    ...
    hasBreakfast: true,
    observations:
      'میخاهم سالگردمونو اونجا جشن بگیریم میتوانید امکانات یا تزئینات خاصی را ترتیب دهید',
    isPaid: true,
    numGuests: 10,
  },
  {
